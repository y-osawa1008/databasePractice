...
CREATE TYPE continent_codes AS ENUM ('Asia','Europe','North America','Africa','Oceania','Antarctica','South America');

CREATE TABLE countries (
  code char(3) NOT NULL DEFAULT '',
  name char(52) NOT NULL DEFAULT '',
  continent continent_codes NOT NULL DEFAULT 'Asia',
...
CREATE TABLE cities (
  ...
  population integer NOT NULL DEFAULT '0',
  PRIMARY KEY (id),
  CONSTRAINT cities_ibfk_1 FOREIGN KEY (country_code) REFERENCES countries(code)
);

COMMENT ON COLUMN cities.country_code IS 'コード';
COMMENT ON COLUMN cities.district IS '地区';
COMMENT ON COLUMN cities.population IS '人口';

CREATE INDEX index_cities_on_country_code ON cities(country_code);

-- CREATE TABLE country_languages
DROP TABLE IF EXISTS country_languages;

CREATE TYPE is_official_codes AS ENUM ('T','F');

CREATE TABLE country_languages (
  country_code char(3) NOT NULL DEFAULT '',
  language char(30) NOT NULL DEFAULT '',
  is_official is_official_codes NOT NULL DEFAULT 'F',
  percentage decimal(4,1) NOT NULL DEFAULT '0.0',
  PRIMARY KEY (country_code,language),
  CONSTRAINT country_languages_ibfk_1 FOREIGN KEY (country_code) REFERENCES countries(code)
);

CREATE INDEX index_country_languages_on_country_code ON country_languages(country_code);
